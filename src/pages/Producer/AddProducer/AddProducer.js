...
import { fetchAddProducer } from "../../../redux/Producers/producerAction";
...
function AddProducer() {
  ...
  const{values,handleChange, handleSubmit,handleBlur,errors,touched}=useFormik({
    ...
    onSubmit:(newProducer)=>{
      console.log("onSubmit triggered",newProducer)
      dispatch(fetchAddProducer(baseUrl,newProducer,handleSuccess,handleFailure));
      navigate("/producer")
    }
  })
...
<div className='carousel-land'>
    ...
    <div className='heading'><h1>Add Producer</h1></div>
